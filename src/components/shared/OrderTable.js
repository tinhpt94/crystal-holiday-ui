...
export default class OrderTable extends Component {
    ...
    render = () => {
        let dataSource = this.props.dataSource ? this.props.dataSource.map(mapOrderToDataSource) : null;
        return (
            <Table dataSource={dataSource} columns={columns} scroll={{ x: 1500, y: 300 }} rowKey={rowItem => rowItem.id}/>
        )
    }
}